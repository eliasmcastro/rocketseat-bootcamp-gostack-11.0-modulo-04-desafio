...
<p align="center">Essa será uma aplicação que deve permitir a criação de clientes, produtos e pedidos, onde o cliente pode gerar novos pedidos de compra de certos produtos, como um pequeno e-commerce</p>
...
```bash
git clone https://github.com/eliasmcastro/rocketseat-bootcamp-gostack-11.0-modulo-04-desafio.git
```
